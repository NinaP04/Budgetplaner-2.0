...
class MainController:
    ...
    def __init__(self, timeout_seconds: int = 1200):
        ...
        self._menu_view = MenuView(self._timed_input)

        self.auth_controller = AuthController(
            self.accounts,
            self.save_data,
            input_func=self._timed_input,
        )
        ...
        self.budget_controller = BudgetController(
            self._timed_input, self.save_data)
    ...
    def _show_main_menu(self) -> str:
        ...
        return self._menu_view.show_main_menu(
            benutzer.get("vorname", ""),
            benutzer.get("name", ""),
        )
    ...
    def _main_menu_loop(self):
        while True:
            ...
            if choice == "6":
                new_email, logout = self.account_controller.menu_loop(
