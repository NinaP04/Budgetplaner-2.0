...
class MenuView:
    """Stellt nur Eingaben und Ausgaben bereit."""
    ...
    def zeige_kategorien(kategorien: dict) -> None:
        ...
        for index, (name, eintraege) in enumerate(kategorien.items(), start=1):
            print(f"{index}. {name} - {len(eintraege)} Einträge")
    ...
    @staticmethod
    def zeige_warnung(text: str) -> None:
        print(Formatter.blau(text))
